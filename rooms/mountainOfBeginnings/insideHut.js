const insideHut = {
    ...
    items: [
        {
            name: 'kettle',
            desc: `It's an enormous kettle. It's full of warm ***porridge***. The kettle is hanging from the ceiling with a ***rope***.`,
            onSwing: () => println(`You come to your senses before the axe connects, and stop the swing.`)
        },
        {
            name: 'rope',
            ...
            onSwing: () => {
                ...
                if (!room.items[1].broken) {
                    ...
                    There's a bed covered with goat furs. Curved drinking horns have been tossed all over the floor. There's a ***chest*** at the foot of the bed.`
                } else {
        ...
        },
        {
            ...
            onTake: () => {
                ...
                bearded.topicsAfterBreakingIn.push({
                    ...
                    "My friend. If you can answer my question honestly, there's a chance I won't kill you." he says plainly.`,
                })
            ...
            onUse: () => {
                ...
                if (disk.roomId === 'frostVillageGate' && room.gateOpen === false) {
                    ...
                    There's a sound of heavy grinding as the black rock ***gate*** rolls to the side, revealing the entrance.  
