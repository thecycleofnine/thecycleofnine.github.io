const godPole3 = {
    ...
    desc: `The carving depicts a gentle goddess wearing a silk-like garment and a keychain at her waist. She is surrounded by unwoven ***threads*** and a ***baby*** is cooing in her arms.`,
    ...
    onFeel: () => {
        if (player.eyesAreOpen) {
            ...
            if (player.friggsBlessing) {
                ...
                println(`You feel gentleness and warmth, but reciprocity has not yet been initiated.`)
            }
        }
    },
    items: [
        ...
        },
        {
            ...
            onEat: () => println(`You try to munch on the ***baby***, but your teeth cannot connect with the wooden skin.
